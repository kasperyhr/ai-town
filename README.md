...
Current version: `v0.9.0`, released on `2026-06-21`.
...
- Purpose-built town structure layer with map-scale bakery, archive, market, workshop, and station landmarks.
...
Next planned version: `v0.9.1`, focused on visual tuning after browser screenshots, including exact crop refinement and resident collision avoidance around buildings.
