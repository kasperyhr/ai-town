...
Current version: `v0.8.3`, released on `2026-06-20`.
...
- Viewport-aware drag bounds, lightweight place labels, and walking sprite animation.
...
Next planned version: `v0.8.4`, focused on richer sprite animation frames and map composition presets.
