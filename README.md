...
Current version: `v0.8.2`, released on `2026-06-20`.
...
- Viewport-aware drag bounds and map-scale pixel landmarks.
...
Next planned version: `v0.8.3`, focused on richer sprite animation frames and map composition presets.
